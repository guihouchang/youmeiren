...
export default {
    ...
    // 文字色
    color_text_base: '#525252',                  // 基本
    color_text_base_inverse: '#ffffff',          // 基本 _ 反色
    color_text_secondary: '#AAAAAA',          // 辅助色
    color_text_placeholder: '#BFBFBF',           // 文本框提示
    ...
    // 边框色
    border_color_base: brandPrimary,
    ...
    // input
    input_label_width: 256,       // InputItem、TextareaItem 文字长度基础值
    input_label_height: 44,
    input_font_size: 17,
